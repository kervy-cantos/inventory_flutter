  ...
  static TextTheme customTextTheme(ColorScheme colorScheme) {
    return TextTheme(
      headlineLarge: TextStyle(
        ...
        color: colorScheme.primary, // Use primary color for heading 1
      ),
      headlineMedium: TextStyle(
        fontSize: 28,
        fontWeight: FontWeight.bold,
        fontFamily: 'Sour_Gummy',
        color: colorScheme.secondary, // Use secondary color for heading 2
      ),
      headlineSmall: const TextStyle(
        fontSize: 18,
        fontWeight: FontWeight.bold,
        fontFamily: 'Sour_Gummy',
        color: Colors.white, // Use onSurface color for heading 3
      ),
      bodyLarge: TextStyle(
        fontSize: 20,
      ...
      labelLarge: TextStyle(
        ...
        fontFamily: 'Montserrat',
        color: colorScheme
            .onSurfaceVariant, // Optional: You can tweak this further
      ),
